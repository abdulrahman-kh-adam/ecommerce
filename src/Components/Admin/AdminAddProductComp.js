      ...
      <Row className="justify-content-start ">
        ...
        <Col sm="8">
          ...
          >
            ...
            <option value="val">First </option>
            <option value="val">Second </option>
            <option value="val">Third </option>
            <option value="val">Fourth </option>
          </select>
          ...
          >
            ...
            <option value="val2">First</option>
            <option value="val2">Second</option>
            <option value="val2">Third</option>
          </select>
...
export default AdminAddProductComp;
